...
export const verifyPayment = async (req, res) => {
    try {
        ...
        const payment = await PaymentModel.findOneAndUpdate({ transactionId }, { paymentStatus: status }, { new: true });
        if (!payment) {
 ...
 * @access Private
 */
export const getPaymentdataController = async (_req, res) => {
    try {
...
export const updatePaymentStatus = async (req, res) => {
    try {
        ...
        const updatedPayment = await PaymentModel.findByIdAndUpdate(id, { paymentStatus: status }, { new: true } // updated data-ti return korbe
        );
        if (!updatedPayment) {
